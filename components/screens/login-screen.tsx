...
export function LoginScreen({ onLogin, onGoogleLogin, onRegister, onForgotPassword, busy, error }: LoginScreenProps) {
    ...
    <div className="min-h-screen bg-background flex flex-col overflow-y-auto">
      ...
      <div className="flex flex-col items-center justify-center px-8 pt-8 pb-4 sm:flex-1 sm:pt-12 sm:pb-8">
        <Image
          ...
          priority
        />
        <h1 className="text-2xl font-bold text-foreground tracking-tight">Konnectik</h1>
        <p className="text-muted-foreground text-sm mt-1">Wi-Fi that follows you</p>
      </div>
